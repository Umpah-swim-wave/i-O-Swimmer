...
class RoutineViewController: UIViewController {
    ...
    private func bindViewModel(){
        ...
        viewModel.routineSubject?.bind(to: tableView.rx.items(cellIdentifier: RoutineSetTVC.identifier, cellType: RoutineSetTVC.self)){ row, element, cell in
            cell.setRoutineContent(title: self.viewModel.routineSetTitleList[row],
