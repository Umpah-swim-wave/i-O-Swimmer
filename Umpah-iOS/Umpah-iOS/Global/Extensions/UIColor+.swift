...
extension UIColor {
    @nonobjc class var upuhBlack: UIColor {
    ...
    @nonobjc class var upuhGreen: UIColor {
    ...
    @nonobjc class var upuhBlue2: UIColor {
        return UIColor(red: 92.0 / 255.0, green: 188.0 / 255.0, blue: 194.0 / 255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var upuhSubOrange: UIColor {
        return UIColor(red: 1.0, green: 195.0 / 255.0, blue: 161.0 / 255.0, alpha: 1.0)
    }

    @nonobjc class var upuhGray: UIColor {
        return UIColor(red: 207.0 / 255.0, green: 214.0 / 255.0, blue: 215.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var upuhSubGray: UIColor {
        return UIColor(red: 223.0 / 255.0, green: 231.0 / 255.0, blue: 233.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var upuhBeginner: UIColor {
        return UIColor(red: 221.0 / 255.0, green: 248.0 / 255.0, blue: 187.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var upuhBadgeOrange: UIColor {
        return UIColor(red: 1.0, green: 168.0 / 255.0, blue: 140.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var upuhIntermediate: UIColor {
        return UIColor(red: 233.0 / 255.0, green: 221.0 / 255.0, blue: 253.0 / 255.0, alpha: 1.0)
    }
